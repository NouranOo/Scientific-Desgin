...
{{--<link rel="stylesheet" href="{{ asset('public/assets/admin/rtl/css/bootstrap-rtl.min.css')}}">--}}
...
{{--<link rel="stylesheet" href="{{ asset('public/assets/admin/rtl/css/AdminLTE-rtl.min.css')}}">--}}
<!-- AdminLTE Skins. Choose a skin from the css/skins
     folder instead of downloading all of them to reduce the load. -->
 <link rel="stylesheet" href="{{asset('public/assets/admin/dist/css/skins/_all-skins.min.css')}}">
{{--<link rel="stylesheet" href="{{ asset('public/assets/admin/rtl/css/skins/_all-skins-rtl.min.css')}}">--}}
