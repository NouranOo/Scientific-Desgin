...
<head>
  ...
  <title>Scientific Design| Log in</title>
  ...
  <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,600,700,300italic,400italic,600italic">
    ...
    <style>
        .login-page {
            background-image: url('{{asset('public/img/test.jpg')}}');
...
<div class="login-box">
  <div class="login-logo">
    <a href="{{url('/')}}"><b>SCIENTIFIC</b>DESIGN</a>
  </div>
  <!-- /.login-logo -->
...
<!-- jQuery 3 -->
<script src="{{url('public/assets/admin')}}/bower_components/jquery/dist/jquery.min.js"></script>
<!-- Bootstrap 3.3.7 -->
<script src="{{url('public/assets/admin')}}/bower_components/bootstrap/dist/js/bootstrap.min.js"></script>
<!-- iCheck -->
<script src="{{url('public/assets/admin')}}/plugins/iCheck/icheck.min.js"></script>
<script>
  $(function () {
    $('input').iCheck({
